# Lesson assumption: dataset has gone through EDA and basic cleaning.
...
# instead of reloading data on every interaction
@st.cache_data
def load_data(path):
    df = pd.read_csv(path)
...
with col_left:
    ...
    # Create Plotly bar chart with towns on x-axis and average resale price on y-axis
